...
public interface ToxRefDataResourceApi {
    /**
    ...
    @ResponseBody
    List<ToxRefDataAll> toxRefDataByStudyId(@Parameter(required = true, description = "Study ID", example = "63") @PathVariable("studyId") Integer studyId);
