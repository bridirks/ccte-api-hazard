...
public interface ToxRefDataRepository extends JpaRepository<ToxRefData, Integer> {
    ...
    @Transactional(readOnly = true)
    Page<ToxRefData> findAllByStudyTypeOrderByStudyIdAsc(@Param("study_type") String studyType, Pageable pageable);
